...
class MstVendorServiceTableSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        foreach ($this->services() as $k => $row) {
            DB::table('mst_vendor_service')->insert([
                'vendor_id'           => array_random(range(1, 18)),
                'service_category_id' => array_random(['A', 'B', 'C']),
                'service_seq'         => array_random(['A-1','A-2','A-3','A-4']).','.array_random(['B-1','B-2','B-3']),
                'service_overview_en' => $row['service_overview_en'],
                'service_overview_jp' => $row['service_overview_jp'],
                'service_detail_en'   => $row['service_detail_en'],
                'service_detail_jp'   => $row['service_detail_jp'],
    ...
    private function services()
    {
        return [
            [
                ...
                'service_overview_en' => 'Et aut aliquid nesciunt aspernatur quia. Nam laboriosam eligendi quam dolores. Cum velit sit explica',
                'service_overview_jp' => '隅すみません。ああ、すすきのあたりは、黒い野原のはぼんやり白くけむりの口笛くちびるのが書いてももういうふうでした。あなたたき、男の子もちにも仕事しごと鳴るのですか」とジョバンニはこおっていました。「ぼ',
                'service_detail_en' => '<h2>Unwilling sportsmen he in questions september therefore described so</h2>
...
',
                'service_detail_jp' => '<h2> 第六章 第五章 第九章 第二章 第八章</h2>
...
',
            ...
            [
                ...
                'service_overview_en' => 'Facilis necessitatibus quam porro. Nam voluptas mollitia aut labore fugiat non praesentium. Eligendi',
                'service_overview_jp' => 'そ談はなくジョバンニさんかがんきょう」とジョバンニに渡わたって、その中にたく河原かわいな野原のはいらい気がした。隣とならんと塩しおあがりませんです。どこからうごいていたとうにはえてせいに白に点々をうた',
                'service_detail_en' => '<h2>Old there any widow law rooms</h2>
...
',
                'service_detail_jp' => '<h2>第六章 第五章 第九章 第七章 第二章</h2>
...
[
    ...
    'service_overview_en' => 'Exercitationem quia vero exercitationem. Quae quae cupiditate sunt molestiae dolore. Nihil qui cupid',
    'service_overview_jp' => 'ひどい高い車掌しゃった奇麗きれでもとのときまでです。カムパネルラが、はっと光らしっかり、汽車は決けっしょうど本にあなたはわかりましたがね君くんだといいえずさびしいと思ってるんでなくうたびしい燐光りませ','service_detail_en' => '<h2>Had strictly mrs handsome mistaken cheerful</h2>
...
','service_detail_jp' => '<h2> 伯母さん 復讐者」</h2>
...
[
    'vendor_name_en' => 'Bashirian and Sons','vendor_name_jp' => 'バシリアンと息子','service_overview_en' => 'Provident laudantium omnis est quo omnis ullam incidunt. Architecto nam excepturi hic nobis ut ipsum','service_overview_jp' => 'どうしの上はんぶんです。ほんとうに見える森の上りもじもじもじして、ところも少しあの森の上に、もっと顔いろには三本のこどもたいした。「蠍さそりだしていま誰だれもいいました。するかおるねえ」「蠍さそりだし','service_detail_en' => '<h2>Eat imagine you chiefly few end ferrars compass</h2>
...
[
    ...
    'service_overview_en' => 'Cum quo adipisci maiores corporis cupiditate. Quis dolor consequatur et ut beatae. Veniam a qui dist',
    'service_overview_jp' => 'ちへいせんでアルコールか電気だろうねえ」ジョバンニが言いう証拠しょうほんもどこでも着つきました。「いか」カムパネルラのお父さんとうのお父さんがねのようにこんな魚だわ」向むこうない。みんなたべらぼうして','service_detail_en' => '<h2>She exposed painted fifteen are noisier mistake led waiting</h2>
...
',
'service_detail_jp' => '<h2> 第十章 第九章 第四章 第二章</h2>
...
[
    ...
    'vendor_name_jp' => 'Balistreri Inc','service_overview_en' => 'Tenetur qui aliquid libero. Veniam eum corporis assumenda vel. Voluptas laborum corrupti inventore r','service_overview_jp' => 'うかべるときでできるので、小さく小さいわいをさまがほんもお互たがっしゃると鷺さぎの木というふくをはいて向むこう岸ぎしの下を通り、さよならんで光ったのでしょうせきのどくでたくさんの牛乳ぎゅうの信号標しん','service_detail_en' => '<h2>Resolution possession discovered surrounded advantages has but few add</h2>
...
','service_detail_jp' => '<h2> 第十一章 第十二章 第十八章 第十三章 第十四章 第十九章</h2>
...
[
    'vendor_name_en' => 'Lehner, Casper and Bode','vendor_name_jp' => 'レーナー、キャスパー、ボーデ','service_overview_en' => 'Officiis voluptas ratione rerum dolorem iusto veniam. Sed voluptatem consequuntur in. Ipsa sint eos ','service_overview_jp' => 'てんきょうを忘わすれていために私のときました。そしてしまうか」「ああではもうその子が言いえず、カムパネルラもあとの間原稿げんこうの尼あまさあもうしを進すすきと、もうごうしろに光る銀杏いちもうあら、みん','service_detail_en' => '<h2>Out too the been like hard off</h2>
...
','service_detail_jp' => '<h2>第五章 第八章 第七章 第四章 第九章</h2>
...
[
    'vendor_name_en' => 'Feeney, Pollich and Rohan','vendor_name_jp' => 'フィーニー、ポーリッヒ、ローハン','service_overview_en' => 'Temporibus atque voluptatem fugiat quia iusto rerum et. Vel ut ducimus odio repudiandae. Veritatis u','service_overview_jp' => 'たりしておいしゃばにすが可愛かわらっとさっきのアセチレンズの大学士だいて行って一つの緑みどりどもその鶴つるで鉄砲丸てっぽがまた言いいか、ジョバンニは、すぐに返事へんきりに飛とんでした。そこらじゅうの姿','service_detail_en' => '<h2>Is we miles ready he might going</h2>
...
','service_detail_jp' => '<h2> 復讐者」 伯母さん</h2>
...
[
    'vendor_name_en' => 'Bradtke-Feest','vendor_name_jp' => 'Bradtke-Feest','service_overview_en' => 'Soluta mollitia quae ullam excepturi sapiente consequatur quos. Natus quisquam minima inventore libe','service_overview_jp' => 'はいいながぐつをはじめましたがたいへんてんだが、霧きり地平線ちへ走りつづって行くのこと」女の子をジョバンニは思いました。ジョバンニは思いながら、こんばっとまり出す小さな虫やなんだん横よこめて降おりまし','service_detail_en' => '<h2>She suspicion dejection saw instantly</h2>
...
','service_detail_jp' => '<h2>第八章 第九章 第七章 第二章 第四章</h2>
...
[
    'vendor_name_en' => 'Buckridge, Mayer and Hand','vendor_name_jp' => 'バックリッジ、メイヤー、そしてハンド','service_overview_en' => 'Labore officiis voluptatibus fuga rem. Labore repellat laudantium unde consectetur sed rerum autem. ','service_overview_jp' => 'あそんな雁がんが監獄かんしんせかいているのを待まったいのでした。けれどもにわたりしめしでぴょんぼりひとにけむるよ。お母さんから湧わくようにまじめましたちとついていましたけれどもそんなを鳴き続つづいて外','service_detail_en' => '<h2>Mr do raising article general norland my hastily</h2>
...
','service_detail_jp' => '<h2> 第十一章 第十七章 第十六章 第十二章</h2>
...
[
    'vendor_name_en' => 'Pfeffer, Muller and Kub','vendor_name_jp' => 'Pfeffer、Muller、そしてKub','service_overview_en' => 'Est sunt officia et eaque mollitia. Aspernatur numquam corporis voluptates assumenda molestiae. Rem ','service_overview_jp' => 'ゆびでそって来るのですねえ」カムパネルラが忘わすれるだけどいっしょうざんでいると、もらだの勇士ゆうきっと町の家々では「「ジョバンニのところがそらしく行っていながらカムパネルラが手を大股おおかっているよ','service_detail_en' => '<h2>Her companions instrument set estimating sex remarkably solicitude motionless</h2>
...
','service_detail_jp' => '<h2>第十八章 第十三章 第十六章 第十七章 第十一章</h2>
...
[
    'vendor_name_en' => 'Morar Group','vendor_name_jp' => 'モラルグループ','service_overview_en' => 'Exercitationem eos quod qui ut et. Ut adipisci harum debitis ullam eveniet veritatis. Libero at even','service_overview_jp' => 'って、だんだろうか」「どこかでたまらないよ、紀元前きげんが二つばかり、ほんとうとき、同じように三つに分けてしますとジョバンニのうして誰だれもほんともだんうしてジョバンニは、わたっと青の旗はたをあいいま','service_detail_en' => '<h2>Meant balls it if up doubt small purse</h2>
...
[
    'vendor_name_en' => 'Hansen, Hills and McKenzie','vendor_name_jp' => 'ハンセン、ヒルズ、マッケンジー','service_overview_en' => 'Debitis a rerum voluptas nisi sequi nisi. Sequi sed repellat voluptatum quidem est nisi. Neque ad di','service_overview_jp' => '子屋かし出されました。「そうになってはいり、虹にじのようにキスを塗ぬったのかなラットにでもいいましたが、「今晩こんどうも忘わすれるのですよ」「それがむずかな場所ばしょうへ行ってもそっちを乗のり出される','service_detail_en' => '<h2>Sense child do state to defer mr of forty</h2>
...
[
    'vendor_name_en' => 'McDermott, Corwin and Romaguera','vendor_name_jp' => 'マクダーモット、コーウィン、ロマグエラ','service_overview_en' => 'Quam neque dolore quae vero autem eveniet nisi est. Explicabo debitis exercitationem vitae voluptatu','service_overview_jp' => '果りんの灯あかりのようの花が、カムパネルラというと思いないったりは、にわらはね上がっていらないでした。ジョバンニは、すっと見えながぐつをゆるひとたどって来ました転てんてんの方たいのために、スコップをつ','service_detail_en' => '<h2>Boy favourable day can introduced sentiments entreaties</h2>
...
','service_detail_jp' => '<h2> 第十二章 第十四章 第十一章 第十六章 第十七章 第十九章</h2>
...
[
    'vendor_name_en' => 'Hayes, Halvorson and Fay','vendor_name_jp' => 'ヘイズ、Halvorsonとフェイ','service_overview_en' => 'Repellat minus aut qui quos culpa voluptates minima. Minima sint assumenda est animi quibusdam nisi ','service_overview_jp' => 'わの中に、眼めをそろそうだまっていると、近くでそらをした。それをちょうやの黒い星座早見せいで上がりたくさんはこをもう、わから出ていましたがたっと顔いろの両手りょうど水が深いほど、そのマジェランの星がた','service_detail_en' => '<h2>As absolute is by amounted repeated entirely ye returned</h2>
...
[
    'vendor_name_en' => 'Zulauf-Mayer','vendor_name_jp' => 'ズラウフ - メイヤー','service_overview_en' => 'Est et voluptatibus officia consequatur. Quia minus suscipit atque omnis. Exercitationem est eius qu','service_overview_jp' => '前きげんかくひょうしろくぼんやり言いいままでもすきだしてしました。ザネリはカトウにつか蠍さそりは顔をした。見たのでしたもんか、なんまり物を言いっぱいにわかに近づいているのがたくさんかくの人鳥へ信号手し','service_detail_en' => '<h2>Expenses as material breeding insisted building to in</h2>
...
[
    'vendor_name_en' => 'Funk-Pfannerstill','vendor_name_jp' => 'ファンクファナーステル','service_overview_en' => 'Dolor repudiandae in omnis fugiat saepe ea repellendus. Voluptatem ipsam molestiae eum distinctio. A','service_overview_jp' => 'じらないように深ふかいが悪わるくあげられます、少した。「ああマジェランプがたくさんは一生けんでかくすきのザネリはもうその小さな子ども遅おくに何がありますから四、五人手をひたしました。その白い光でちゃん','service_detail_en' => '<h2>Can curiosity may end shameless explained</h2>
...
[
    'vendor_name_en' => 'Ortiz-Romaguera','vendor_name_jp' => 'オルティスロマグエラ','service_overview_en' => 'Temporibus aut delectus assumenda sed. Ut hic recusandae maiores sapiente sequi et. Qui libero exped','service_overview_jp' => 'ちの電燈まめでんというつぶがつきました。カムパネルラの頬ほおには、波なみばかり秋だねえ」といのすすきとおもした。崖がけの下の向むこうを、一すじ白く腹はらじゅうはまたあうと言いいのでしょうのだ。いきなり','service_detail_en' => '<h2>Affronting imprudence do he he everything</h2>
...
','service_detail_jp' => '<h2> 第十五章 第十七章 手配書 第十一章</h2>
